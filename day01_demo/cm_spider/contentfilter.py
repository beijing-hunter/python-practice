...
from .htmlparse import htmlParseFacotry
...
def filterKey(hrefUrl, platformId):
    ...
    filterKey = ["北京", "咽拭子", "核酸检测", "新发地", "基因", "测序", "确诊病例", "新冠", "抗体", "病毒", "疾控", "高风险", "中风险", "风险等级", "疫情",
                 "复盘", "抗疫", "战时机制", "冷冻", "发热门诊", "群体免疫", "二次暴发", "出京史", "流行病", "流调", "排查", "起源", "追溯", "口罩", "世卫组织",
                 "一级响应", "二级响应", "三级响应", "无症状"]
